...
export default class TerrainGenerator {
     ...
     * @returns {Number}
     */
    get islandStart() { return this.#islandStart; };
    
    /**
     * Island End.
     * @returns {Number}
     */
    get islandEnd() { return this.#islandEnd; };
    ...
    #generateIslandStart(level, map) {
        ...
        const planeMesh = new THREE.Mesh(
            new THREE.PlaneBufferGeometry(this.terrainWidth, this.#terrainLength, 1, this.#terrainLength * 0.1),
    ...
    #generateTerrainAssets(terrainAssetGroup, amount) {
        ...
        randAssets.forEach(asset => {
            ...
            asset.name = 'Asset';
            asset.position.set(randomX, randomY, randomZ - 25);
    ...
    #generateClouds(cloudGroup, amount) {
        ...
        Array(amount).fill().forEach((_, idx) => {
            ...
            const z = this.#mesh.geometry.getAttribute('position').getZ(randomVertexIdx) - (Math.random() * 200 + 200);
